...
const TermsAndConditionsContent = ({ small }) => (
  <section style={{ maxWidth: 700, margin: 0 }}>
    <ul style={{ fontSize: small ? 13 : 15, color: "#23272f", lineHeight: 1.7, paddingLeft: 18 }}>
      <li>
        <strong>Acceptance:</strong> By booking with Bhada24, you agree to abide by all terms and conditions outlined here and on our website.
      </li>
      <li>
      ...
      <li>
        <strong>Liability:</strong> Bhada24 is not liable for delays, losses, or damages due to circumstances beyond our control (e.g., weather, strikes, accidents).
      </li>
      <li>
        <strong>Privacy:</strong> Your data is handled as per our <a href="https://www.bhada24.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#e57368", fontWeight: 600 }}>Privacy Policy</a>.
      </li>
      <li>
        <strong>Support:</strong> For any queries, contact <a href="mailto:support@bhada24.com">support@bhada24.com</a> or <a href="tel:+919140251119">+91-9140251119</a>.
      </li>
    </ul>
    <div className="alert alert-info mt-4" style={{ fontSize: small ? 12 : 14 }}>
      Please read all terms carefully before booking. Bhada24 reserves the right to update these terms at any time.
    </div>
  </section>
);
